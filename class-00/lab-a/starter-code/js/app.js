...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the let variable declaration from `const to `const`.
  // rando is defined in the while loop starting at 32, and then console logged outside of the code block on line 38. To console log rando, it will need to be labeled as a cost on 33, or move the console log into the while loop.
  console.log(viewed);
